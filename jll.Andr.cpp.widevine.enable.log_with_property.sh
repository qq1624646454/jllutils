...
${BYellow}------------------------------------------------------${AC}
${Fgreen}persist.sys.jll_wv = 0x1<<1 = 0x1  ${Fpink}# enable the ALOGV${AC}
${Fgreen}persist.sys.jll_wv = 0x1<<2 = 0x2  ${Fpink}# enable the ALOGD${AC}
${BYellow}------------------------------------------------------${AC}
...
\n#define ALOGV(...) \\\\\
\n            do { \\\\\
\n                if (property_get_int32(\"persist.sys.jll_wv\", 0) & 0x1) { \\\\\
...
\n#define ALOGD(...) \\\\\
\n            do { \\\\\
\n                if (property_get_int32(\"persist.sys.jll_wv\", 0) & 0x2) { \\\\\
\n                    (void)ALOG(LOG_INFO, LOG_TAG, __VA_ARGS__); \\\\\
\n                }\\\\\
\n            } while (0)\
\n\
